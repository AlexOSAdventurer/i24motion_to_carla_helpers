...
This will launch the docker image shell. CARLA and the i24motion_to_carla subfolder (i24motion_to_carla/i24motion_to_carla) are already mounted within the container for you as 
1. /workspaces/carla
